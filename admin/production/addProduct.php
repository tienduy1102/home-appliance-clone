  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <a class="btn btn-primary" href="product.php" role="button">Trở Về</a>
        ...
        <div class="form-group">
          ...
          <input required minlength="1" maxlength="500" name="review" type="text" class="form-control" id="exampleInputPassword1" placeholder="Nhập mô tả">
        </div>
        <div class="form-group">
